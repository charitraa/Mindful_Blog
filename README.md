...
<img src="docs/screenshots/editor.png" width="600">
🛠️ Tech Stack
...
🚀 Getting Started
1️⃣ Clone the repo
bashgit clone https://github.com/username/blogify.git
cd blogify
...
bashDATABASE_URL=postgres://user:password@localhost:5432/blogify
...
bashgit clone https://github.com/your-username/blogify.git
cd blogify
...
textfeat: add dark mode toggle
fix: resolve login JWT expiration issue
docs: update README with new setup instructions

Example:
bashgit commit -m "feat: add comment reply functionality"
...
VersionSupportedmain✅v1.x.x✅< v1.0❌
